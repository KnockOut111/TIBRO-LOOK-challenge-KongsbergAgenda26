...
depth-camera-build:
	docker compose -f docker-compose.yml up -d --build realsense_camera_thread depth_scan_thread depth_camera_thread
	docker compose -f docker-compose.yml logs -f realsense_camera_thread depth_scan_thread depth_camera_thread

depth-camera-restart:
	docker compose -f docker-compose.yml restart realsense_camera_thread depth_scan_thread depth_camera_thread

depth-camera-stop:
	docker compose -f docker-compose.yml stop realsense_camera_thread depth_scan_thread depth_camera_thread

depth-camera-clean:
	docker compose stop realsense_camera_thread depth_scan_thread depth_camera_thread
	docker compose rm -f realsense_camera_thread depth_scan_thread depth_camera_thread
